...
public class ReplayListener implements InputProcessor{
	
	protected HungryFrogGame hungryfrog;
	protected boolean sonActive = true;
	
	public ReplayListener(HungryFrogGame hungryfrog){
